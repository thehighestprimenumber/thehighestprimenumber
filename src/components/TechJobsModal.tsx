...
export default function TechJobsModal({ technology, onClose }: TechJobsModalProps) {
          ...
          <Stack gap={3}>
            ...
            >
              <Stack gap={1}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Typography color="text.secondary">{techData.firstUsed}</Typography>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography fontWeight={600}>Last Used:</Typography>
                  <Typography color="text.secondary">{techData.lastUsed}</Typography>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Typography fontWeight={600}>Companies:</Typography>
                  <Typography color="text.secondary">{techData.companies.join(', ')}</Typography>
                </Box>
              </Stack>
            </Paper>
            ...
            <Box>
              <Typography variant="h6" sx={{ mb: 2 }}>
                Used in {relatedJobs.length} {relatedJobs.length === 1 ? 'role' : 'roles'}
              </Typography>
              <Stack gap={2}>
                {relatedJobs.map((job) => (
                  <Paper
                  ...
                  >
                    ...
                    <Typography variant="caption" sx={{ color: 'primary.main', fontStyle: 'italic', mt: 1, display: 'block' }}>
